...
import { OTP_COOLDOWN_SECONDS, OTP_EXPIRY_MINUTES } from '@/lib/constants';
  ...
  try {
    ...
    try {
      ...
      await sendEmail(
        ...
        `Your new security verification OTP code is: ${code}. It will expire in exactly ${OTP_EXPIRY_MINUTES} minutes.`
      );
